...
(function() {
	...
	ChangeMediaController.$inject = ["$scope", "$rootScope", "$stateParams", "$state", "Authentication", "MediaObject", "FileUploader"];
...
(function() {
	...
	MediaObject.$inject = ["$http", "$stateParams"];
...
(function() {
	...
	QuestionnaireController.$inject = ["Questionnaire", "Section", "Field"];
...
(function() {
	...
	ChangeSettingsController.$inject = ["$scope", "$rootScope", "$stateParams", "$state", "Authentication", "SettingsObject"];
...
(function() {
	...
	SettingsObject.$inject = ["$http", "$stateParams"];
