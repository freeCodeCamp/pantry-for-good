...
/* @ngInject */
function DriverUserController($filter, VolunteerUser, CustomerAdmin, moment, $window, $timeout, $state,$rootScope, GeoLocation, $ngRedux) {
	var self = this;
	...
	this.isDisabled = function() {
		if (this.customers) {
			return !$filter('filter')(this.customers, {isChecked: true}).length;
		}
	}
	...
	function selectAll() {
		this.customers.forEach(function(customer) {
			customer.isChecked = !this.allChecked;
		});
	}
}
