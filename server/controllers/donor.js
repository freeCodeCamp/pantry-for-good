...
import * as updateLinkedFields from '../lib/update-linked-fields'
...
export default {
  ...
  async create(req, res) {   
    ...
    updateLinkedFields.updateFields(clientRoles.DONOR,req.body.fields,donor._id)
  ...
  async update(req, res) { 
    ...
    const donor = new Donor(extend(req.donor, req.body))    
    const savedDonor = await donor.save()
